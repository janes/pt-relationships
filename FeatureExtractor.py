...
class FeatureExtractor:
    ...
    def extract_features(self, rel):
        ...
        self.extract_ngrams(' '.join(before_tokens), "BEF")
        self.extract_ngrams(' '.join(between_tokens), "BET")
        self.extract_ngrams(' '.join(after_tokens), "AFT")
    ...
    def extract_ngrams(self, text, context):
        ...
        grams = StringIO.StringIO()
        for g in ngrams(chrs, self.N_GRAMS_SIZE):
            grams.write(''.join(g) + '_' + context + ' ')
        return grams
